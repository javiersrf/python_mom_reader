...
def criar_tabela_caso_nao_exista():
    ...
    try:
        ...
        con = mydb.cursor()
        con.execute("CREATE TABLE IF NOT EXISTS smartfleet.machine_operation(id BIGINT NOT NULL AUTO_INCREMENT,operator_id BIGINT NOT NULL,message_sent_id BIGINT NULL,total_volume FLOAT NULL DEFAULT 0, harvestedstems INT NULL DEFAULT 0.0, fuelconsumption FLOAT NULL DEFAULT 0.0, enginetime FLOAT NULL DEFAULT 0.0,drivendistance FLOAT NULL DEFAULT 0.0, machine_enginetime FLOAT NULL DEFAULT 0.0, machine_drivendistance FLOAT NULL DEFAULT 0.0, machine_fuelconsumption FLOAT NULL DEFAULT 0.0, created_at DATETIME NOT NULL,send tinyint NULL,PRIMARY KEY (id));")
        mydb.close()
